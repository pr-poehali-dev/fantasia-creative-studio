...
const reviews = [
  ...
  { name: 'Елена Иванова', course: 'Синтезатор', text: 'Дочка в восторге! Занимается уже полгода, прогресс заметен. Спасибо преподавателям за индивидуальный подход!', rating: 5, photo: 'https://cdn.poehali.dev/projects/bdde1fd2-cbd4-4bf0-bfd7-fe42f02ad620/files/65187dd4-2bc2-4f49-88fe-f754cf8384ac.jpg' },
  ...
  { name: 'Наталья Федорова', course: 'Синтезатор', text: 'Прекрасная студия с душевной атмосферой!', rating: 5, photo: 'https://cdn.poehali.dev/projects/bdde1fd2-cbd4-4bf0-bfd7-fe42f02ad620/files/8cba01f9-3006-4502-86fe-341668306a15.jpg' },
  ...
  { name: 'Екатерина Белова', course: 'Гитара', text: 'Мечтала научиться играть на гитаре. Здесь помогли!', rating: 5, photo: 'https://cdn.poehali.dev/projects/bdde1fd2-cbd4-4bf0-bfd7-fe42f02ad620/files/4065b76a-4d7d-4092-8fe0-41370d7c5508.jpg' },
