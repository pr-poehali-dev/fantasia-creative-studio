...
const reviews = [
  ...
  { name: 'Дмитрий Смирнов', course: 'Актерское мастерство', text: 'Занятия помогли мне раскрепоститься и обрести уверенность. Отличная атмосфера и профессиональный подход!', rating: 5, photo: photos[1] },
  ...
  { name: 'Ольга Соколова', course: 'Укулеле', text: 'Всегда мечтала научиться играть. Здесь помогли осуществить мечту!', rating: 5, photo: photos[4] },
  { name: 'Михаил Кузнецов', course: 'Сценическая речь', text: 'Занятия по сценической речи превзошли все ожидания!', rating: 5, photo: photos[5] },
