...
const reviews = [
  ...
  { name: 'Дмитрий Смирнов', course: 'Актерское мастерство', text: 'Занятия помогли мне раскрепоститься и обрести уверенность. Отличная атмосфера и профессиональный подход!', rating: 5, photo: 'https://cdn.poehali.dev/projects/bdde1fd2-cbd4-4bf0-bfd7-fe42f02ad620/files/b40ba524-3951-46a9-a19c-6b083f95896b.jpg' },
  { name: 'Елена Иванова', course: 'Синтезатор', text: 'Дочка в восторге! Занимается уже полгода, прогресс заметен. Спасибо преподавателям за индивидуальный подход!', rating: 5, photo: photos[2] },
  { name: 'Сергей Волков', course: 'Электрогитара', text: 'Отличная школа! Преподаватели настоящие профессионалы.', rating: 5, photo: photos[3] },
  { name: 'Ольга Соколова', course: 'Укулеле', text: 'Всегда мечтала научиться играть. Здесь помогли осуществить мечту!', rating: 5, photo: 'https://cdn.poehali.dev/projects/bdde1fd2-cbd4-4bf0-bfd7-fe42f02ad620/files/8204444c-5a38-4c80-8efc-7442fbffe77d.jpg' },
